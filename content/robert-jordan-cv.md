...
## Author / Trainer 2019 - Present
* Learn Infrastructure as Code with Terraform. Hosted on O'Reilly Live Online Training. Produced by Pearson Video Training. Hosted on O'Reilly Live Online Training. 2022
* Learn Infrastructure as Code with AWS CDK. Hosted on O'Reilly Live Online Training. Produced by Pearson Video Training. Hosted on O'Reilly Live Online Training. 2022
* Terraform on AWS. NobleProg on site instructor led training. 2022.
* Introducing Infrastructure as Code with Terraform. Produced by Pearson Video Training. Hosted on O'Reilly Live Online Training. 2019.
...
ESC Entertainment was formed in the spring of 2001 for the purpose of creating state of the art visual effects for feature films. The largest projects completed during my tenure include The Matrix Reloaded and The Matrix Revolutions.
### Systems Engineering Supervisor
I was responsible for the overall architecture of the computing infrastructure at ESC. This position included supervising three Systems Engineers. In this role I was responsible for both production rendering systems and corporate information systems such as Exchange Server, SQL Server, and IIS. We managed approximately 1000 Windows based servers, 75 TB of high-performance NAS storage (Network Appliance and BlueArc), and 300 workstations. I was also responsible for managing vendor relationships with all technology vendors.

## Lucasfilm Ltd., Novato, California, 1999 – 2003 
### Systems Administrator, Lucasfilm
Responsible for designing and implementing Windows based systems for multi-company enterprise. Lucasfilm is a heterogeneous environment and much of my work there concerned interoperability between various operating systems including: IRIX, Linux, MacOS (classic and OSX), and Solaris. My responsibilities at Lucasfilm were primarily centered on typical IT functions, however I was also responsible for developing and maintaining a small production network and render farm for previsualization work.

### Systems Administrator, Industrial Light and Magic (ILM)
Responsible for all aspects of Microsoft technologies at ILM. This included Exchange Server, client desktop rollouts, file and print services, etc.
...
* Introducing Infrastructure as Code with Terraform. Instructor. Produced by Pearson Video Training. Hosted on O'Reilly Live Online Training. 2019.
* Take Terraform to the Next Level. Instructor. Produced by Pearson Video Training. Hosted on O'Reilly Live Online Training. 2019.
* AWS Certified Big Data - Specialty Complete Video Course. Instructor. Produced by Pearson IT Certification. Hosted on O'Reilly Live Online Training. 2019.
